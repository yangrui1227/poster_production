...
return [
    ...
    'aliases' => [
        '@ciniran/dic' => '@backend/modules/ciniran/yii2-dic'
    ],   
    ...
    'on beforeRequest' => function($event) { 
        ...
        \yii\base\Event::on(\yii\db\BaseActiveRecord::className(), \yii\db\BaseActiveRecord::EVENT_AFTER_DELETE, ['backend\models\AdminLog', 'afterDelete2']);
